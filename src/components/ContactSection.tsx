    ...
    <section id="contact" className="py-24 relative overflow-hidden">
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          >
            <form className="glass p-8 md:p-10 rounded-3xl border border-primary/20 shadow-[0_0_30px_rgba(212,175,55,0.1)] relative group">
              ...
              <div className="space-y-6 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-accent/80 mb-2 font-medium">Name</label>
                  ...
                  <div>
                    <label className="block text-accent/80 mb-2 font-medium">Email</label>
                ...
                <div>
                  <label className="block text-accent/80 mb-2 font-medium">Event Type</label>
                  <select className="w-full bg-black/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all appearance-none">
                ...
                <div>
                  <label className="block text-accent/80 mb-2 font-medium">Message</label>
                  <textarea rows={4} className="w-full bg-black/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all" placeholder="Tell us about your event..."></textarea>
                </div>
                
                <button type="button" className="w-full py-4 bg-gradient-to-r from-primary to-yellow-600 text-black font-bold rounded-xl hover:shadow-[0_0_20px_rgba(212,175,55,0.6)] transition-all duration-300 flex items-center justify-center text-lg">
          ...
          >
            <div className="glass p-8 rounded-3xl flex items-start space-x-6 hover:border-primary/30 transition-colors duration-300">
              ...
              <div>
                ...
                <p className="text-accent/70 leading-relaxed">
                 Careertronics Global services<br />
                  Raipur, C.G
                </p>
              </div>
            </div>
            ...
            <div className="glass p-8 rounded-3xl flex items-start space-x-6 hover:border-primary/30 transition-colors duration-300">
              ...
              <div>
                ...
                <p className="text-accent/70 mb-4">We're available 24/7</p>
                <a href="tel:+91-8461835410" className="text-2xl font-bold text-primary hover:text-white transition-colors">
                  +91-8461835410
                </a>
              </div>
            </div>
            ...
            <div className="glass p-8 rounded-3xl flex items-start space-x-6 hover:border-primary/30 transition-colors duration-300">
              ...
              <div>
                ...
                <a href="mailto:hello@balloonsunlimited.com" className="text-lg text-primary hover:text-white transition-colors">
